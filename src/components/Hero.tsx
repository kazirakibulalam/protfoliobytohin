      ...
      <div className="container px-4 mx-auto relative z-10">
        <div className="flex flex-col lg:flex-row items-center justify-between gap-12">
          <div className="lg:w-1/2 space-y-6 text-center lg:text-left">
            ...
            <p className="text-xl md:text-2xl text-gray-300">Graphic Designer &amp; Video Editor</p>
          ...
          <div className="lg:w-1/2 flex justify-center lg:justify-end">
            <div className="relative w-72 h-72 md:w-96 md:h-96">
              ...
              <div className="absolute inset-2 overflow-hidden rounded-full bg-navy border-2 border-gold/30">
                <img alt="Rakibul Alam Tohin" className="w-full h-full object-cover" src="https://i.imgur.com/f3yjGLi.png" />
              </div>
            </div>
          </div>
        </div>
